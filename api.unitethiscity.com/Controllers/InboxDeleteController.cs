/******************************************************************************
 * Filename: InboxDeleteController.cs
 * Project:  UTC WebAPI
 * 
 * Description:
 * Controller for deleting inbox messages
******************************************************************************/
using System;
...
{
    public class InboxDeleteController : ApiController
    {
        public void Post(Guid token, int id)
        {
            ...
            db.SubmitChanges();
            Logger.LogAction("Inbox-Delete", accID);
        }
    }
}
