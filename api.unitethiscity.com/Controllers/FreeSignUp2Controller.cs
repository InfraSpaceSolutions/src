/******************************************************************************
 * Filename: FreeSignUp2Controller.cs
 * Project:  UTC WebAPI
 * 
 * Description:
...
{
    public class FreeSignUp2Controller : ApiController
    {
        WebDBContext db;
        ...
        public LoginCredentials Post(FreeSignUp2 jn)
        {
            db = new WebDBContext();
            ...
            Logger.LogAction("SignUp-2", rsAcc.AccID, 0);
