...
* 
* Revision History:
* $Log: /MonstersUnlimited/utc/unitethiscity.com/website/App_Code/CreditCardUtility.cs $
 * 
 * 1     1/13/13 9:18p Mterry
 * merge object dev
******************************************************************************/
using System;
...
public class CreditCardUtility
{
    ...
    /// </summary>
    /// <param name="cardNumber">card number as a string</param>
