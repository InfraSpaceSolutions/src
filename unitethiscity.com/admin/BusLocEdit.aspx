<%@ Page Language="C#" MasterPageFile="~/admin/SiteAdminRestricted.master" ClientIDMode="Static" AutoEventWireup="true" CodeFile="BusLocEdit.aspx.cs" Inherits="admin_BusLocEdit" %>
...
<menu:Admin ID="BusMenu" runat="server" Name="Businesses" Prefix="Bus" Type="View" />
	...
	<table class="formTable" cellspacing="1">
		...
		<tr>
			<td class="formField" colspan="2">If you are updating the address, then you must click the "Set Location Coords" button so that the Google map will show the updated address.</td>
		</tr>
		<tr>
