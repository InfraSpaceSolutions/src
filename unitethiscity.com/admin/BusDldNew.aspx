<%@ Page Language="C#" MasterPageFile="~/admin/SiteAdminRestricted.master" AutoEventWireup="true" CodeFile="BusDldNew.aspx.cs" Inherits="admin_BusDldNew" %>
...
<menu:Admin ID="BusMenu" runat="server" Name="Businesses" Prefix="Bus" Type="View" />
    ...
    <br />
    <br />
	<h3>Add New Social Deal Definition</h3>
    <br />
	<table class="formTable" cellspacing="1">
		<tr>
			<td class="formField">Name *</td>
