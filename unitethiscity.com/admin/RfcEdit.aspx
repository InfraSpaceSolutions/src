<%@ Page Language="C#" MasterPageFile="~/admin/SiteAdminRestricted.master" AutoEventWireup="true" CodeFile="RfcEdit.aspx.cs" Inherits="admin_RfcEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyPlaceHolder" Runat="Server">
	...
	<asp:UpdatePanel ID="RfcEditUpdatePanel" runat="server">
	<ContentTemplate>
