<%@ Page Language="C#" MasterPageFile="~/admin/SiteAdminRestricted.master" AutoEventWireup="true" CodeFile="MsjEdit.aspx.cs" Inherits="admin_MsjEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyPlaceHolder" Runat="Server">
	<menu:Admin ID="MsjMenu" runat="server" Name="Message Jobs" Prefix="Msj" Type="Edit" />
