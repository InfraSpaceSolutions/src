<%@ Page Language="C#" MasterPageFile="~/admin/SiteAdminRestricted.master" AutoEventWireup="true" CodeFile="CatNew.aspx.cs" Inherits="admin_CatNew" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyPlaceHolder" Runat="Server">
	<menu:Admin ID="CatMenu" runat="server" Name="Categories" Prefix="Cat" Type="Create" />
