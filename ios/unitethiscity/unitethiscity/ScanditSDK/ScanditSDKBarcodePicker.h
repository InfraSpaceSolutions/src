 ...
 * ({@link #restrictActiveScanningArea:}).
 *
 * @since 4.4
 *
 * @param orientation the device orientation for which to set the scan area. Must be
 *   either {@link ORIENTATION_LANDSCAPE} for landscape orientations
 *   (landscape-right and landscape-left), or {@link ORIENTATION_PORTRAIT}
 ...
 */
- (void)setActiveScanningArea:(CGRect)rect forOrientation:(Orientation)orientation;
 ...
 * @since 4.4
 *
 * @param orientation the device orientation. Must either be {@link ORIENTATION_LANDSCAPE},
 *    or {@link ORIENTATION_PORTRAIT}
 ...
 *    calls to {@link #setActiveScanningArea:forOrientation:} is returned.
 * @see {@link #setActiveScanningArea}
 */
- (CGRect)activeScanningAreaForOrientation:(Orientation)orientation;
