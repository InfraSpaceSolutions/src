//
//  SearchEntertainerListViewController.m
//  unitethiscity
//
...
@implementation SearchEntertainerListViewController
...
{
    [super viewDidLoad];
    [self setScreenName:@"Search Entertainer List"];
...
{
    return [[[UTCApp sharedInstance] matchingEntertainers] count];
}
...
-(UITableViewCell*) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    LocationInfo* locInfo = [[[UTCApp sharedInstance] matchingEntertainers] objectAtIndex:[indexPath row]];
    ...
    BOOL isFavorite = [[[UTCApp sharedInstance] favoriteEntertainers] containsObject:locInfo];
...
{
    [[[UTCApp sharedInstance] rootViewController] openSearchEntertainersText:YES];
}
...
-(void) detailsButtonClicked:(UIButton*)sender
{
    ...
    // get the location info from the dictionary of all locations
    LocationInfo* locInfo = [[[UTCApp sharedInstance] matchingEntertainers] objectAtIndex:[sender tag]];
    [[UTCApp sharedInstance] setSelectedLocation:locInfo.locID];
