 ...
 */
public class AnalyticsBusinessFragment extends Fragment {

    private String mName = Constants.ANALYTICS_BUSINESS;

    public Constants.MenuType mMenuType = Constants.MenuType.SUB;
    public Constants.MenuID mMenuID = Constants.MenuID.ANALYTICS_BUSINESS;
    ...
    public AnalyticsBusinessFragment() {
                                ...
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int whichButton) {
                                        ...
                                        if(Utils.hasHoneycomb()) {
                                            mLoadSummaryAnalyticsTask.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, mID, mBusinessID);
                                        }
                                        else {
                                            mLoadSummaryAnalyticsTask.execute(mID, mBusinessID);
                                        }
                                    }
                                })
    ...
    private void updateAnalytics() {
        ...
        Logger.info(mName, "Adding " + String.valueOf(mSummaryAnalytics.size()) +
                " analytics for ID " + String.valueOf(mID) + ", business ID " + String.valueOf(mBusinessID));
    ...
    private class LoadSummaryAnalyticsTask extends AsyncTask<Integer, Void, Integer> {
        protected Integer doInBackground(Integer... params) {
            ...
            mAnalyticsRetrievalError = AnalyticsParser.setSummaryAnalytics(params[0], params[1]);
        ...
        protected void onPostExecute(Integer error) {
            ...
            mSummaryAnalytics = dm.getSummaryAnalyticsBusiness();
            updateAnalytics();
